...
/**
    The code that ties all of the scenes together and exports the data
...
public class SaveData : MonoBehaviour
{
    ...
    /* The expected scene build order
    0 Main
    1 Par Gender
    2 Par Description
    3 Par Make
    ...
    */
    ...
    /**
        Moves from main to the proper scene depedning on the navigation data
    */
    ...
    /**
        Moves from Avatar Gender to the proper scene depedning on the navigation data
    */
    ...
    /**
        Moves from Par Gender to the proper scene depedning on the navigation data
    */
    ...
    /**
        Moves from Par Description to the proper scene depedning on the navigation data
    */
    ...
    /**
        Moves from Avatar Description to the proper scene depedning on the navigation data
    */
    ...
    /**
        Moves from Creation Tutorial to the proper scene depedning on the navigation data
    */
    ...
    /**
        Moves from Avatar Creater to the proper scene depedning on the navigation data
    */
    ...
    /**
        Moves from Par Creater to the proper scene depedning on the navigation data
    */
    ...
    /**
        Gathers the navigation data from the designated php script and moves from main to the proper destination
    */
    IEnumerator inputData(){
        Debug.Log("Starting Data Input");
        bool successful = true;
        WWWForm form = new WWWForm();
        //The designated php script
    ...
    /**
        Outputs the data to the designated php script
    */
